require('lspkind').init({
    ...
    --
    -- default: 'default'/ 'codicons',
    preset = 'default',

    -- override preset symbols
    --
    -- default: {}
    symbol_map = require('config.lsp_kind').cmp_kind
})
...
local function add_lsp_buffer_keybindings(bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>ca', '<cmd>lua require("plugin.telescope").code_actions()<CR>', opts)
...
require('lspconfig').sumneko_lua.setup {
  cmd = { vim.fn.getenv 'HOME' .. '/.local/share/nvim/lsp_servers/sumneko_lua/extension/server/bin/Linux/lua-language-server' },
  on_attach = on_attach,
  capabilities = capabilities,
  settings = {
    Lua = {
