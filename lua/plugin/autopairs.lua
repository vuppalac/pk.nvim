...
function M.setup()
  ...
  --     map_cr = autopairs_config.map_cr, --  map <CR> on insert mode
  --     map_complete = autopairs_config.map_complete, -- it will auto insert `(` after select function or method item
  ...
  if cmp_status_ok then
    ...
    local map_char = autopairs_config.map_char
